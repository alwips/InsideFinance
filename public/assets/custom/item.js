var Item = (function() {
    ...
    var base_url = 'http://'+location.host+'/item';
    $.ajaxSetup({
        dataType: 'JSON',
        headers: {
    ...
    aksi.view = () => {
        $('#dt-ajax-object').DataTable({
            ...
            "createdRow" : function(row,data,dataIndex){
                $(row).attr('data-key',data.iditem);
            },
            "columns": [
                { "data": "no" },
                { "data": "nama" },
                { "data": "harga", "render": function (harga, type, full, meta) {
                    if(harga>0)
                        var harga = numToRupiah(harga,'Rp ');
                    else
                        var harga = 'Rp '+0;
                    return harga;
                }},
                ...
                { "data": "iditem", "render": function(iditem, type, full, meta) {
                    return `<a href="`+base_url+`/req/`+iditem+`/edit" class="icofont icofont-ui-edit"></a> | \
                    ...
                    $(".modal-body").html('\
                        <table>\
                            ...
                            <tr>\
                                <td>Harga</td>\
                                <td>:</td>\
                                <td>'+numToRupiah(data.harga,'Rp ')+'</td>\
                            </tr>\
                            <tr>\
                                <td>Satuan</td>\
                                <td>:</td>\
