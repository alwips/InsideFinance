var COA = (function() {
    ...
    var base_url = 'http://'+location.host+'/coa';
    $.ajaxSetup({
        dataType: 'JSON',
        headers: {
    ...
    aksi.view = () => {
        $('#dt-ajax-object').DataTable({
            ...
            "columns": [
                ...
                { "data": "idcoa", "render": function(idcoa, type, full, meta) {
                    return `<a href="`+base_url+`/req/`+idcoa+`/edit" class="icofont icofont-ui-edit"></a> | \
