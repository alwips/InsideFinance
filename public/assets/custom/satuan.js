var Satuan = (function() {
    ...
    var base_url = 'http://'+location.host+'/satuan';
    $.ajaxSetup({
        dataType: 'JSON',
        headers: {
    ...
    aksi.view = () => {
        $('#dt-ajax-object').DataTable({
            ...
            "createdRow" : function(row,data,dataIndex){
                $(row).attr('data-key',data.idsatuan);
            },
            "columns": [
                { "data": "satuan" },
                { "data": "keterangan" },
                ...
                { "data": "idsatuan", "render": function(idsatuan, type, full, meta) {
                    return `<a href="`+base_url+`/req/`+idsatuan+`/edit" class="icofont icofont-ui-edit"></a> | \
